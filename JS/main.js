...
console.log(me[0]());
console.log(me[1]());
console.log("Function for me: "+me[2]());
console.log("Function for b: "+b);
console.log(me[3]());
console.log("function me: "+me[4]());

function findFirstN(n, a){
    if(a.length<n){
        console.log("Insufisant element in this array");
    }
    else{
        let x = "["+a[0];
